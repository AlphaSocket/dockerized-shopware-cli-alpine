...
ENV \
	...
	SETUP_DEPENDENCIES_RUNTIME="bash htop curl git mysql-client  $SETUP_DEPENDENCIES_SECURITY php7 php7-phar php7-soap php7-iconv php7-xml php7-json php7-zlib php7-gd php7-ctype php7-gd php7-pdo_mysql php7-dom php7-mcrypt php7-curl php7-openssl php7-opcache" \
...
ADD imports/bin/setup /usr/local/bin/setup/1519297595
ADD imports/bin/config /usr/local/bin/config/1519297595


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519297595 1>/dev/stdout 2>/dev/stderr
