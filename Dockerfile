...
ADD imports/bin/setup /usr/local/bin/setup/1519299057
ADD imports/bin/config /usr/local/bin/config/1519299057


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519299057 1>/dev/stdout 2>/dev/stderr
