...
ADD imports/bin/setup /usr/local/bin/setup/1519298265
ADD imports/bin/config /usr/local/bin/config/1519298265


RUN chmod +x -R /usr/local/bin && \
    sync && \
    /usr/local/bin/setup/1519298265 1>/dev/stdout 2>/dev/stderr
